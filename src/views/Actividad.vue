  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conceptos para diseño
        p.mb-4 Analizar los distintos aspectos que intervienen en la comunicación visual a través de la identificación y aplicación de conceptos clave.
